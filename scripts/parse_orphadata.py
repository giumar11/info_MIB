...
def main():
    ...
    candidates = [
        raw_dir / 'orphadata' / 'orphadata_epidemiology_it.xml',
        raw_dir / 'orphadata_epidemiology_it.xml',
    ]
    input_path = next((str(p) for p in candidates if p.exists()), str(candidates[0]))
