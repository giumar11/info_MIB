...
- [Giulia] - Solution Manager
- [Lucia] - Customer Engagement Manager
- [Giulia] - Product Management Lead
- [Melania] - Design/UX Research Lead
- [Lucia] - Visual Designer
- [Sara] - Technical Lead and Fullstack Engineer
- [Tommaso] - Fullstack Engineer
- [Melania] - Fullstack Engineer


# Team Communication and Tools

Team Communicatons: <Slack>
...
Collaborative Design Documents and workshop tool: <link to Miro > 

HiFi Prototyping collaboreative Design tool: <Link to Figma >

Long form communication: Email

Teleconferencing Meeting Collaboration: < Google Meet >

# Team Commitments
We the team will adhere to and work according to [Agile Sprint Product Developement Process] and best practices. 
We the team commit to giving it our best effort.
We the team will work collaboratively as partners with each other.
